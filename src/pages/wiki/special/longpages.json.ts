...
// Machine-readable long-pages list at /wiki/special/longpages.json. Lists all
// published articles ranked by body word count, longest first. The inverse of
// Special:ShortPages: surfaces the most comprehensive articles so programmatic
// consumers can discover which entries already have deep coverage. Word count
